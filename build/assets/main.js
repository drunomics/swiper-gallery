...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_nodelist_foreach_polyfill__ = __webpack_require__(338);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_loglevel__ = __webpack_require__(90);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_05_content_gallery_gallery__ = __webpack_require__(131);




__WEBPACK_IMPORTED_MODULE_2_loglevel___default.a.disableAll();
// Enable for debugging.
__WEBPACK_IMPORTED_MODULE_2_loglevel___default.a.enableAll();



window.SwiperGallery = {};
window.SwiperGallery.gallery = __WEBPACK_IMPORTED_MODULE_3__components_05_content_gallery_gallery__["a" /* Gallery */];
window.SwiperGallery.galleryMobile = __WEBPACK_IMPORTED_MODULE_3__components_05_content_gallery_gallery__["b" /* GalleryFsMobileScroll */];
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = SwiperGalleryBreakpoints;
/**
 * Swiper gallery breakpoints handler.
 *
 * @constructor
 */
function SwiperGalleryBreakpoints() {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_loglevel__ = __webpack_require__(90);
...
var GalleryPI = function () {
  function GalleryPI() {
    _classCallCheck(this, GalleryPI);
  }

  _createClass(GalleryPI, null, [{
    key: 'trackNewPageImpression',


    /**
     * Tracks a page impression as defined by the global window object.
     */
    value: function trackNewPageImpression() {
      ...
      __WEBPACK_IMPORTED_MODULE_0_loglevel___default.a.info('URL fragment changed to ' + window.location.hash);

      // Provide the new page impression to google tag manager.
      if (typeof dataLayer !== 'undefined') {
        __WEBPACK_IMPORTED_MODULE_0_loglevel___default.a.info('Google Tag Manager triggered with ' + window.location.href);
        dataLayer.push({
      ...
      if (typeof window.iom !== 'undefined' && typeof window.iom.c === 'function') {
        __WEBPACK_IMPORTED_MODULE_0_loglevel___default.a.info('IVW triggered');
        iom.c(iam_data, 1);
      }
    }
  }]);
...
/* harmony default export */ __webpack_exports__["a"] = (GalleryPI);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return GalleryFsMobileScroll; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_swiper_dist_js_swiper_js__ = __webpack_require__(340);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_featherlight_release_featherlight_min__ = __webpack_require__(337);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_featherlight_release_featherlight_min___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_featherlight_release_featherlight_min__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_enquire_js__ = __webpack_require__(336);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_enquire_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_enquire_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_loglevel__ = __webpack_require__(90);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_loglevel___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_loglevel__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_underscore__ = __webpack_require__(341);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__gallery_pi__ = __webpack_require__(130);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__00_base_02_breakpoints_breakpoints__ = __webpack_require__(129);
...
var breakpoints = new __WEBPACK_IMPORTED_MODULE_6__00_base_02_breakpoints_breakpoints__["a" /* SwiperGalleryBreakpoints */]();

// Limit smaller than 200 can trigger flickering behavior when resizing the
// gallery.
var debounce_limit = 200;
...
var Gallery = function () {
  _createClass(Gallery, null, [{
    ...
    value: function attach(context, settings) {
      var selector = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '.gallery';
      ...
      context.querySelectorAll(selector).forEach(function (element) {
        ...
        element.querySelectorAll('.gallery-launcher').forEach(function (e) {
    ...
    key: 'addClass',
    value: function addClass(scope, querySelector, className) {
      scope.querySelectorAll(querySelector).forEach(function (element) {
  ...
  _createClass(Gallery, [{
    key: 'setAdSwiperSlideHeight',
    value: function setAdSwiperSlideHeight() {
      if (breakpoints.isMobile()) {
        return;
      }
      var slides = [].concat(_toConsumableArray(this.content.querySelectorAll('.gallery-slide')));
      var firstSlide = slides[0];
      var adslides = slides.filter(function (e) {
        return e.dataset.hash.indexOf('slide-ad') !== -1;
      });
      adslides.forEach(function (e) {
    ...
    key: 'updateGallery',
    value: function updateGallery(origin) {
      var _this = this;
      ...
      if (start - this.elapsed > 50) {
        ...
        setTimeout(function () {
          _this.swiper.slideTo(_this.activeSlide);
          if (!breakpoints.isMobile()) {
            _this.swiperThumb.slideTo(_this.activeSlide);
          }
        }, 500);
    ...
    key: 'calculateGalleryImageHeightWidth',
    value: function calculateGalleryImageHeightWidth(heightwidth) {
      var featherlightContent = document.querySelector('.featherlight-content');
      var wh = [];
    ...
    key: 'setImageHeightWidth',
    value: function setImageHeightWidth(image, availableImageHeight, boxImageWidth) {
      var boxImageHeight = availableImageHeight - (parseInt(image.closest('.media-image').offsetHeight, 10) - parseInt(image.offsetHeight, 10));
      ...
      if (imageHeight <= boxImageHeight && imageWidth <= boxImageWidth) {
        ...
        if (imageWidth === 0 || imageHeight === 0) {
          ...
          if (boxImageHeight > imageHeight) {
            var paddingTopBottom = (boxImageHeight - imageHeight) / 2;
        ...
        var imageCalculatedHeight = boxImageWidth * imageHeight / imageWidth;
        var imageCalculatedWidth = boxImageHeight * imageWidth / imageHeight;
        ...
        if (boxImageHeight > imageHeight) {
          ...
          var _paddingTopBottom = (boxImageHeight - imageCalculatedHeight) / 2;
          image.parentElement.style.setProperty('padding-top', _paddingTopBottom + 'px');
          image.parentElement.style.setProperty('padding-bottom', _paddingTopBottom + 'px');
        } else {
    ...
    value: function setImageHeight() {
      ...
      var galleryHeightWidth = this.calculateGalleryImageHeightWidth([windowheight, windowwidth]);

      featherlightContent.style.setProperty('width', galleryHeightWidth.width + 'px');

      var featherlightStyle = window.getComputedStyle(featherlightContent, null);
      var flPaddingTopBottom = parseInt(featherlightStyle.getPropertyValue("padding-top"), 10) + parseInt(featherlightStyle.getPropertyValue("padding-bottom"), 10);
      var flPaddingLeftRight = parseInt(featherlightStyle.getPropertyValue("padding-left"), 10) + parseInt(featherlightStyle.getPropertyValue("padding-right"), 10);

      var thumbHeight = this.thumbContent.offsetHeight;
      var headerHeight = this.content.querySelector('.gallery__header').offsetHeight;
      var headerOffset = this.content.querySelector('.gallery__header').offsetTop;
      var images = this.content.querySelector('.swiper-wrapper').querySelectorAll('img');
      ...
      var availableImageHeight = galleryHeightWidth.height - thumbHeight - headerHeight - headerOffset - flPaddingTopBottom;
      ...
      var boxImageWidth = galleryHeightWidth.width - flPaddingLeftRight;
      ...
      images.forEach(function (image, index) {
        ...
        var imageWrapper = image.closest('.media-image');
        var shareLinks = imageWrapper.querySelectorAll('.media__share-links');
        ...
        if (shareLinks.clientHeight === 0) {
          ...
          imageWrapper.querySelectorAll('.media__image').forEach(function (element) {
        ...
        if (breakpoints.isMobile()) {
          ...
          // the correct values.
          setTimeout(function () {
            _this2.setImageHeightWidth(image, availableImageHeight, boxImageWidth);
          }, 50);
        }
      }, this);
      this.swiper.update(true);
    ...
    key: 'setActiveSlideByHash',
    value: function setActiveSlideByHash(hash) {
      // Get gallery slides.
      var slides = this.content.querySelectorAll('.swiper-wrapper')[0].querySelectorAll('.gallery-slide');
      var activeSlide = this.element.querySelectorAll("[data-hash='" + hash + "']")[0];
      this.activeSlide = [].concat(_toConsumableArray(slides)).indexOf(activeSlide);
    }
    ...
    value: function launch(hash) {
      ...
      window.addEventListener('resize', __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_underscore__["debounce"])(function () {
        if (_this3.orientationchange) {
          _this3.orientationchange = false;
        } else {
          _this3.setImageHeight();
          _this3.setContainerHeight();
          _this3.hideAddressBar();
        }
      }, debounce_limit));
      ...
      // format.
      window.addEventListener('orientationchange', __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_underscore__["debounce"])(function () {
        _this3.updateGallery('orientationchange');
        if (_this3.orientationchange) {
          __WEBPACK_IMPORTED_MODULE_3_loglevel___default.a.info('Change orientation of device to ' + _this3.orientation);
          _this3.orientationchange = false;
        } else {
          _this3.setImageHeight();
          _this3.setContainerHeight();
      ...
      var event = new Event('gallery:launched');
    ...
    key: 'quickHideAddressBar',
    value: function quickHideAddressBar() {
      var self = this;
     ...
     * when necessary.
     */
    value: function registerBreakpointConfig() {}
    ...
    value: function applyDefaultConfig() {
      if (!this.active) {
        // Do nothing if gallery is not active.
        return;
      }
      __WEBPACK_IMPORTED_MODULE_3_loglevel___default.a.info('Apply default config');
      this.config = this.defaultConfig;
    ...
    key: 'applyBreakpointConfig',
    value: function applyBreakpointConfig(name, breakpointConfig) {
      if (!this.active) {
        // Do nothing if gallery is not active.
        return;
      }
      __WEBPACK_IMPORTED_MODULE_3_loglevel___default.a.info('Apply breakpoint config ' + name);
      this.config = this.defaultConfig;
      this.orientationchange = true;
    ...
    key: 'registerGalleryPageImpressionEventHandler',
    value: function registerGalleryPageImpressionEventHandler() {
      // Swiper seems to overwrite other onHashChange event handler, thus use
      // swiper to fire the event handler again.
      this.swiper.on('slideChangeStart', __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4_underscore__["debounce"])(function () {
        __WEBPACK_IMPORTED_MODULE_5__gallery_pi__["a" /* default */].trackNewPageImpression();
      }, debounce_limit));
    }
    ...
    key: '_createSwiper',
    value: function _createSwiper() {
      __WEBPACK_IMPORTED_MODULE_3_loglevel___default.a.info('-- create swiper');
      ...
      __WEBPACK_IMPORTED_MODULE_3_loglevel___default.a.info('Creating swiper thumbs instance');
    ...
    key: 'showSlideIfGiven',
    value: function showSlideIfGiven() {
      var hash = this.getSlideHash();
      if (hash) {
        this.launch(hash);
      }
    }
    ...
    key: 'stopPropagation',
    value: function stopPropagation(button) {
    ...
    key: 'preventSwipeOnButtons',
    value: function preventSwipeOnButtons() {
    ...
    key: 'defaultConfig',
    get: function get() {
      var loopedSlides = this.content.querySelectorAll('.swiper-wrapper .swiper-slide:not(.swiper-slide-duplicate)').length;
    ...
    key: 'defaultThumbConfig',
    get: function get() {
      var loopedSlides = this.thumbContent.querySelectorAll('.swiper-wrapper .swiper-slide:not(.swiper-slide-duplicate)').length;
...
var GalleryFsMobileScroll = function (_Gallery) {
  _inherits(GalleryFsMobileScroll, _Gallery);

  function GalleryFsMobileScroll() {
    _classCallCheck(this, GalleryFsMobileScroll);

    return _possibleConstructorReturn(this, (GalleryFsMobileScroll.__proto__ || Object.getPrototypeOf(GalleryFsMobileScroll)).apply(this, arguments));
  }

  _createClass(GalleryFsMobileScroll, [{
    key: 'registerBreakpointConfig',
    ...
    value: function registerBreakpointConfig() {
      ...
      var self = this;
      __WEBPACK_IMPORTED_MODULE_2_enquire_js___default.a.register('screen and (max-width:533px)', {
        match: function match() {
          _this5.applyBreakpointConfig('mobile', {
            freeMode: true,
            direction: 'vertical',
            spaceBetween: 10,
            autoHeight: true,
            ...
            // Enable lazy loading
            lazyLoading: true,
            paginationCustomRender: function paginationCustomRender() {
              return self.setPagination();
            }
          });
          _this5._initializeAllAds();
        },
        unmatch: function unmatch() {
          return _this5.applyDefaultConfig();
        }
      });
    }
  }, {
    ...
    value: function setPagination() {
      // Get gallery slides.
      var slides = this.content.querySelectorAll('.swiper-wrapper')[0].querySelectorAll('.gallery-slide');
      var activeSlide = slides[0].parentElement.querySelector('.swiper-slide-active');
      var current = [].concat(_toConsumableArray(slides)).indexOf(activeSlide) + 1;
      var total = parseInt(slides.length, 10);
    ...
    value: function _createSwiper() {
      ...
      _get(GalleryFsMobileScroll.prototype.__proto__ || Object.getPrototypeOf(GalleryFsMobileScroll.prototype), '_createSwiper', this).call(this);
      this.swiper.update(true);

      // Update swiper gallery on image load
      // to avoid issues with container height.
      this.swiper.on('onLazyImageLoad', function (swiper) {
        swiper.update();
      });

      this.swiper.on('onLazyImageReady', function (swiper) {
        swiper.update();
      });
      ...
      this.swiper.on('slideChangeStart', function (swiper) {
        if ((swiper.realIndex + 1) % 6 === 0) {
          var gallery_ad = self.swiperContainer.querySelectorAll('.gallery-ad')[(swiper.realIndex + 1) / 6 - 1];
        ...
        var slides = _this6.content.querySelector('.swiper-wrapper').querySelectorAll('.gallery-slide');
        var index = 0;
        [].concat(_toConsumableArray(slides)).some(function (slide) {
          var activeSlide = slide.parentElement.querySelector('.swiper-slide-active');
          if (activeSlide.length !== 0) {
            index = [].concat(_toConsumableArray(slide.parentElement.children)).indexOf(activeSlide);
            return true;
          }
          return false;
        });
        _this6.activeSlide = parseInt(index, 10);
      });
    }
  }, {
    key: '_initializeAllAds',
    value: function _initializeAllAds() {
      var self = this;
      // Without the timeout, the ads won't load, if the gallery is opened via a link
      // (with a #, which opens the gallery automatically)
      setTimeout(function () {
        self.swiperContainer.querySelectorAll('.gallery-ad').forEach(function (gallery_ad) {
          self._initializeAd(gallery_ad);
        });
      }, 0);
    }
    ...
    key: '_initializeAd',
    value: function _initializeAd(ad) {
...
var QueryHandler = __webpack_require__(335);
var each = __webpack_require__(126).each;
...
var MediaQuery = __webpack_require__(333);
...
var MediaQueryDispatch = __webpack_require__(334);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(91), __webpack_require__(342)(module)))
