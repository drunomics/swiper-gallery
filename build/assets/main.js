...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(65), __webpack_require__(344)(module)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_idempotent_babel_polyfill__ = __webpack_require__(341);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_idempotent_babel_polyfill___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_idempotent_babel_polyfill__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_nodelist_foreach_polyfill__ = __webpack_require__(342);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_loglevel__ = __webpack_require__(49);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_05_gallery_gallery_fs_mobile_scroll__ = __webpack_require__(133);
...
window.SwiperGallery.galleryMobile = __WEBPACK_IMPORTED_MODULE_3__components_05_gallery_gallery_fs_mobile_scroll__["a" /* GalleryFsMobileScroll */];
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_loglevel__ = __webpack_require__(49);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_underscore__ = __webpack_require__(129);
...
var GalleryAds = function () {
  function GalleryAds() {
    _classCallCheck(this, GalleryAds);
  }

  _createClass(GalleryAds, [{
    key: 'init',
     ...
     *   Mobile version flag.
     */
    value: function init(swiper, isMobile) {
      ...
      window.addEventListener('resize', __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_underscore__["debounce"])(function () {
        //this.swiper.update();
      }, 100));
    ...
    key: 'getAdSlides',
    value: function getAdSlides() {
      var ad_slides = [];
      [].forEach.call(this.swiper.slides, function (slide) {
        var ad_container = slide.querySelectorAll('.ad-entity-container');
    ...
    key: 'initializeAdSlide',
    value: function initializeAdSlide(offset) {
      offset = offset || 0;
      var swiper = this.swiper;
      var index = swiper.activeIndex + offset;
    ...
    key: 'initializeAd',
    value: function initializeAd(ad_slide) {
      var ad = ad_slide.querySelector('.ad-entity-container');

      __WEBPACK_IMPORTED_MODULE_0_loglevel___default.a.info('initializeAd');
      __WEBPACK_IMPORTED_MODULE_0_loglevel___default.a.info(ad);

      if (!ad.classList.contains('initialization-disabled')) {
        __WEBPACK_IMPORTED_MODULE_0_loglevel___default.a.info('-- skip initialized');
        return;
      }

      var id = ad.id;
      var postfix = Math.random().toString(36).substr(2, 3);

      // Fix id.
      ad.id = id + '_' + postfix;
      // The sub element must have a unique id as well.
      var sub_div = ad.querySelector('div');
    ...
    key: 'initializeAllAds',
    value: function initializeAllAds() {
      var self = this;
...
/* harmony default export */ __webpack_exports__["a"] = (GalleryAds);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return GalleryFsMobileScroll; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_swiper_dist_js_swiper_js__ = __webpack_require__(92);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_featherlight_release_featherlight_min__ = __webpack_require__(128);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_enquire_js__ = __webpack_require__(340);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__gallery__ = __webpack_require__(135);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_loglevel__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_loglevel___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_loglevel__);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var GalleryFsMobileScroll = function (_Gallery) {
  ...
  _createClass(GalleryFsMobileScroll, [{
    ...
    value: function createSwiperInstance() {
      // We need to set a fixed height on the slider so it can calculate
      // meaningful measurements.
      this.fixVerticalContainerHeight();
      _get(GalleryFsMobileScroll.prototype.__proto__ || Object.getPrototypeOf(GalleryFsMobileScroll.prototype), 'createSwiperInstance', this).call(this);
    ...
    value: function paginationHandler(swiper, current, total) {
      // Get gallery slides.
      ...
      var calculated_current = [].concat(_toConsumableArray(slides)).indexOf(activeSlide) + 1;
      var calculated_total = parseInt(slides.length, 10);
...
}(__WEBPACK_IMPORTED_MODULE_3__gallery__["a" /* default */]);
...
var GalleryPI = function () {
  ...
  _createClass(GalleryPI, null, [{
    ...
    value: function trackNewPageImpression() {
      ...
      __WEBPACK_IMPORTED_MODULE_0_loglevel___default.a.info('track ' + window.location.hash);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_loglevel__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_loglevel___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_loglevel__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_underscore__ = __webpack_require__(129);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_underscore___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_underscore__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__gallery_pi__ = __webpack_require__(134);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__gallery_ads__ = __webpack_require__(132);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var Gallery = function () {
  ...
  function Gallery(element, settings) {
    ...
    this.adHandler = new __WEBPACK_IMPORTED_MODULE_5__gallery_ads__["a" /* default */]();
  ...
  _createClass(Gallery, [{
    ...
    key: 'fixImageHeightsWidth',
    value: function fixImageHeightsWidth(image, availableImageHeight, boxImageWidth) {
    ...
    key: 'fixSlideHeights',
    value: function fixSlideHeights() {
      var _this = this;
      ...
      images.forEach(function (image, index) {
        ...
        if (_this.isMobile()) {
          ...
          _this.fixImageHeightsWidth(image, availableImageHeight, boxImageWidth);
        }
      }, this);
    ...
    key: 'fixBreakerSlideHeights',
    value: function fixBreakerSlideHeights() {
      if (this.isMobile()) {
        return;
      }
      var firstSlide = this.content.querySelector('.swiper-wrapper').querySelector('.gallery-slide[data-swiper-slide-index="0"]:not(.swiper-slide-duplicate)');
    ...
    key: 'fixVerticalContainerHeight',
    value: function fixVerticalContainerHeight() {
      if (!this.isMobile()) {
        return;
      }
      var featherlightHeight = document.querySelector('.featherlight').clientHeight;
    ...
    value: function launch() {
      ...
      window.addEventListener('resize', __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_underscore__["debounce"])(this.onResize.bind(this), debounce_limit));
      ...
      // format.
      window.addEventListener('orientationchange', __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_underscore__["debounce"])(this.onOrientationChange.bind(this), debounce_limit));
    ...
    value: function initFeatherlight() {
      ...
      if (this.active) {
        __WEBPACK_IMPORTED_MODULE_2_loglevel___default.a.info('reinitialize active instance');
        ...
        window.jQuery.featherlight(self.element, {
          ...
          afterContent: function afterContent() {
            __WEBPACK_IMPORTED_MODULE_2_loglevel___default.a.info('initialize new instance');
    ...
    key: 'createSwiperInstance',
    value: function createSwiperInstance() {
      this.swiper = new __WEBPACK_IMPORTED_MODULE_0_swiper_dist_js_swiper_js___default.a(this.swiperContainer, this.config);
      this.swiperThumb = new __WEBPACK_IMPORTED_MODULE_0_swiper_dist_js_swiper_js___default.a(this.swiperThumbContainer, this.thumbConfig);
      this.swiperThumb.controller.control = this.swiper;
      this.swiper.controller.control = this.swiperThumb;

      __WEBPACK_IMPORTED_MODULE_2_loglevel___default.a.info('create swiper instance ' + this.swiper.params.direction);
      ...
      __WEBPACK_IMPORTED_MODULE_4__gallery_pi__["a" /* default */].trackNewPageImpression();

      // Track new page impressions due to hash changes.
      this.swiper.on('slideChangeTransitionEnd', __WEBPACK_IMPORTED_MODULE_4__gallery_pi__["a" /* default */].trackNewPageImpression);
    }
    ...
    key: 'preventSwipeOnButton',
    value: function preventSwipeOnButton(buttonClass) {
      var stopPropagation = function stopPropagation(e) {
        e.stopPropagation();
      };
      var button = this.swiperContainer.querySelector(buttonClass);
...
var QueryHandler = __webpack_require__(339);
var each = __webpack_require__(127).each;
...
var MediaQuery = __webpack_require__(337);
...
var MediaQueryDispatch = __webpack_require__(338);
