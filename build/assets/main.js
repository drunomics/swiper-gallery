...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(64), __webpack_require__(344)(module)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_loglevel__ = __webpack_require__(91);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_loglevel__ = __webpack_require__(91);
  ...
  _createClass(GalleryAds, [{
    ...
    value: function init(swiper, isMobile) {
      if (typeof Drupal.ad_entity === "undefined") {
        __WEBPACK_IMPORTED_MODULE_0_loglevel___default.a.info('Ad entity library not found.');
        return;
      }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_swiper_dist_js_swiper_js__ = __webpack_require__(128);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_featherlight_release_featherlight_min__ = __webpack_require__(127);
...
var GalleryFsMobileScroll = function (_Gallery) {
  ...
  _createClass(GalleryFsMobileScroll, [{
    ...
    key: 'setPagination',
    value: function setPagination(swiper, current, total) {
      // Get gallery slides.
...
var Gallery = function () {
  ...
  _createClass(Gallery, [{
    ...
    key: 'fixMobileContainerHeight',
    value: function fixMobileContainerHeight() {
      if (!this.isMobile()) {
        return;
      }
    ...
    key: 'initSwiperConfig',
    value: function initSwiperConfig() {
    ...
    value: function registerGalleryPageImpressionEventHandler() {
      ...
      this.swiper.on('slideChangeStart', __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_underscore__["debounce"])(function () {
    ...
    key: 'createSwiperInstance',
    value: function createSwiperInstance() {
      __WEBPACK_IMPORTED_MODULE_2_loglevel___default.a.info('-- creating swiper instance for: ' + this.type);
